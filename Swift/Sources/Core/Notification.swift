...
extension KJBasePlayer {
    internal struct N {
        ...
        static let timerName = NSNotification.Name(rawValue: "kPlayerRuningCommonTimerKey")
    }
    ...
    internal func setupNotification() {
        NotificationCenter.default.addObserver(self,
                                               ...
                                               name: KJBasePlayer.N.playViewRectName,
                                               object: nil)
    }
    ...
    @objc func playerViewRectChanged(_ notification: Notification) {
        guard let userInfo = notification.userInfo,
              let _ = userInfo[N.playViewRectKey] as? CGRect else { return }

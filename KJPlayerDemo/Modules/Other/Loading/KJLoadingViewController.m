...
#import "KJLoadingViewController.h"
#import <KJPlayer/KJPlayerHeader.h>

@interface KJLoadingViewController () <KJPlayerBaseViewDelegate>{
    int index;
}
...
@implementation KJLoadingViewController
- (void)viewDidLoad {
    [super viewDidLoad];

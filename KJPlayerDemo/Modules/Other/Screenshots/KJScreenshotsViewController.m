...
#import "KJScreenshotsViewController.h"

@interface KJScreenshotsViewController () <KJPlayerDelegate>

@property(nonatomic,strong)UIImageView *imageView;

@end

@implementation KJScreenshotsViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)buttonAction:(UIButton*)sender{
    PLAYER_WEAKSELF;
    [self.player kj_currentTimeScreenshots:^(UIImage * _Nonnull image) {

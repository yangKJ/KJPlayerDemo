...
#import "KJSkipViewController.h"

#if __has_include(<KJPlayer/KJBasePlayer+KJSkipTime.h>)

#import <KJPlayer/KJBasePlayer+KJSkipTime.h>

@interface KJSkipViewController () <KJPlayerDelegate, KJPlayerSkipDelegate>

@end

@implementation KJSkipViewController
- (void)viewDidLoad {
    [super viewDidLoad];

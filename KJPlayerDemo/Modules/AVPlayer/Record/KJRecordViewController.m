...
#import "KJRecordViewController.h"

#if __has_include(<KJPlayer/KJBasePlayer+KJRecordTime.h>)

#import <KJPlayer/KJBasePlayer+KJRecordTime.h>

@interface KJRecordViewController () <KJPlayerDelegate, KJPlayerRecordDelegate>

@end

@implementation KJRecordViewController
- (void)backItemClick{

...
#import "KJCacheViewController.h"

#if __has_include(<KJPlayer/KJAVPlayer+KJCache.h>)

#import <KJPlayer/KJBasePlayer+KJCache.h>

@interface KJCacheViewController () <KJPlayerDelegate, KJPlayerCacheDelegate>

@end

@implementation KJCacheViewController
- (void)viewDidLoad {
    [super viewDidLoad];
